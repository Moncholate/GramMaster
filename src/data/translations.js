export const translations = {
  es: {
    ...
    reporteAyuda: 'Cuéntame qué esperabas que hiciera la app. Lo de abajo se manda solo: dice en qué estado estaba, que es más útil que un pantallazo.',
  ...
  en: {
    ...
    reporteAyuda: 'Tell me what you expected the app to do. The part below is filled in for you: it says what state the app was in, which is more useful than a screenshot.',
